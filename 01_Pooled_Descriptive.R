...
standard_vars <- c(
  "cohort", "country", "region", "country_name",  # Added region and country_name
...
# Add region variable based on cohort (for Cox model adjustment)
...
print(table(pooled_data$region, useNA = "ifany"))
