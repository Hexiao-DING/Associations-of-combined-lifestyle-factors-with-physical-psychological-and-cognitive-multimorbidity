...
# IMPORTANT: Must match the wave prefixes in the actual data files
COHORT_WAVES <- list(
  CHARLS = list(baseline = 1, followup = c(2, 3, 4)),
  ELSA   = list(baseline = 1, followup = c(2, 3)),   # FIXED: ELSA data uses w1 as baseline
  HRS    = list(baseline = 10, followup = c(11, 12, 13, 14)),
